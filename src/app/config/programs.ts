  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Recette coupe-faim au cacao cru',
        icon: Cookie,
      ...
      {
        id: 'detox_epsom',
        title: 'Bain Détox Epsom',
        description: 'Drainage par osmose inversée',
        icon: Droplet,
        route: '/app/dashboard/detox/bain-epsom',
        badge: 'Bonus',
        badgeColor: 'gold',
        available: true,
      },
      {
        id: 'detox_respiration',
        title: 'Respiration Lymphe',
        description: 'Pompez vos toxines par le souffle',
        icon: Activity,
        route: '/app/dashboard/detox/respiration',
        badge: 'Bonus',
        badgeColor: 'gold',
        available: true,
      }
