...
export default function Up1Page() {
  useEffect(() => {
    ...
    if (!document.getElementById(scriptId)) {
      ...
      script.id = scriptId;
      script.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/6a19c0960be01eeda6f044ac/v4/player.js";
      script.async = true;
    ...
    <div className="min-h-screen bg-black text-white font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-3xl px-4 pt-8 pb-24 text-center space-y-6">
        ...
        <div className="w-full max-w-[400px] mx-auto mt-8">
          {/* Vturb Embed */}
          {/* @ts-ignore */}
          <vturb-smartplayer id="vid-6a19c0960be01eeda6f044ac" style={{ display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px' }}></vturb-smartplayer>
