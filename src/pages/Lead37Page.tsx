...
export default function Lead37Page() {
  useEffect(() => {
    const scriptId = 'vturb-player-script-lead37';
    if (!document.getElementById(scriptId)) {
      const script = document.createElement("script");
      script.id = scriptId;
      script.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/6a137df1d82ffcdf02238cfd/v4/player.js";
      script.async = true;
      ...
      <main className="flex-grow">
        ...
        <section id="vsl" className="bg-black py-6 px-2 overflow-hidden">
          <div className="mx-auto w-full max-w-[400px]">
            {/* @ts-ignore */}
            <vturb-smartplayer id="vid-6a137df1d82ffcdf02238cfd" style={{ display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px' }}></vturb-smartplayer>
          </div>
        </section>
        ...
        {/* Call to Action */}
        <div className="flex justify-center w-full pt-8 pb-2 bg-white px-4 lead1-37">
          <a href="https://checkout.kashpay.com.br/checkout/checkout-1779658426499" className="w-full max-w-xl mx-auto bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-lg shadow-xl text-lg md:text-2xl uppercase transform transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl active:scale-95 text-center leading-tight block">
