...
export default function Lead2Page() {
  useEffect(() => {
    const scriptId = 'vturb-player-script-lead2';
    if (!document.getElementById(scriptId)) {
      const script = document.createElement("script");
      script.id = scriptId;
      script.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/6a0d140ebf3b7f17424beb77/v4/player.js";
      script.async = true;
      ...
      <main className="flex-grow">
        ...
        <section id="vsl" className="bg-black py-6 px-2 overflow-hidden">
          <div className="mx-auto w-full max-w-[400px]">
            {/* @ts-ignore */}
            <vturb-smartplayer id="vid-6a0d140ebf3b7f17424beb77" style={{ display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px' }}></vturb-smartplayer>
          </div>
        </section>
        ...
        {/* Call to Action */}
        <div className="flex justify-center w-full pt-8 pb-2 bg-white px-4 lead2">
