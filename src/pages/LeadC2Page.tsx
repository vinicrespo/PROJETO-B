...
export default function LeadC2Page() {
  useEffect(() => {
    const scriptId = 'vturb-player-script-leadc2';
    if (!document.getElementById(scriptId)) {
      const script = document.createElement("script");
      script.id = scriptId;
      script.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/6a1f17ce526a8ffedf11a572/v4/player.js";
      script.async = true;
      ...
      <main className="flex-grow">
        ...
        <section id="vsl" className="bg-black py-6 px-2 overflow-hidden">
          <div className="mx-auto w-full max-w-[400px]">
            {/* @ts-ignore */}
            <vturb-smartplayer id="vid-6a1f17ce526a8ffedf11a572" style={{ display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px' }}></vturb-smartplayer>
          </div>
        </section>
